...
wave_0_per_point6=
wave_0_per_point7=mx=if(above(mx,.99),(.99-mx),mx);
wave_0_per_point8=my=if(above(my,.99),(.99-my),my);
wave_0_per_point9=mx=if(below(mx,.01),(.99+mx),mx);
wave_0_per_point10=my=if(below(my,.01),(.99+my),my);
wave_0_per_point11=
...
wave_1_per_point6=
wave_1_per_point7=mx=if(above(mx,.99),(.99-mx),mx);
wave_1_per_point8=my=if(above(my,.99),(.99-my),my);
wave_1_per_point9=mx=if(below(mx,.01),(.99+mx),mx);
wave_1_per_point10=my=if(below(my,.01),(.99+my),my);
wave_1_per_point11=
...
wave_2_per_point6=
wave_2_per_point7=mx=if(above(mx,.99),(.99-mx),mx);
wave_2_per_point8=my=if(above(my,.99),(.99-my),my);
wave_2_per_point9=mx=if(below(mx,.01),(.99+mx),mx);
wave_2_per_point10=my=if(below(my,.01),(.99+my),my);
wave_2_per_point11=
...
wave_3_per_point6=
wave_3_per_point7=mx=if(above(mx,.99),(.99-mx),mx);
wave_3_per_point8=my=if(above(my,.99),(.99-my),my);
wave_3_per_point9=mx=if(below(mx,.01),(.99+mx),mx);
wave_3_per_point10=my=if(below(my,.01),(.99+my),my);
wave_3_per_point11=
...
per_frame_1=bl = 3.8;
per_frame_2=ul = 7.9;
per_frame_3=rate = 11.9;
per_frame_4=cha = .01;
per_frame_5=
per_frame_6=gv = if(above(gv,bl),  if(below(gv,ul),  if(above(fps,rate),gv + cha,gv - cha),  ul-.1),bl+.1);
per_frame_7=
per_frame_8=gamma = gv;
per_frame_9=
per_frame_10=monitor = gv;
per_frame_11=
