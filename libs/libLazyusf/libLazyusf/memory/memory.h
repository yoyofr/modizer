...
#ifdef DEBUG_INFO
#define debug_read if (state->debug_log) fprintf(state->debug_log, "read(%08x) = %08x\n", state->address, *(state->rdword));
#define debug_writeB if (state->debug_log) fprintf(state->debug_log, "write(%08x, %08x )\n", state->address, state->cpu_byte);
#define debug_writeHW if (state->debug_log) fprintf(state->debug_log, "write(%08x, %08x )\n", state->address, state->cpu_hword);
#define debug_writeW if (state->debug_log) fprintf(state->debug_log, "write(%08x, %08x )\n", state->address, state->cpu_word);
#define debug_writeDW if (state->debug_log) fprintf(state->debug_log, "write(%08x, %08x )\n", state->address, state->cpu_dword);
#else
#define debug_read
#define debug_writeB
#define debug_writeHW
#define debug_writeW
#define debug_writeDW
#endif


#define read_word_in_memory() {state->readmem[state->address>>16](state);debug_read;}

#define read_byte_in_memory() {state->readmemb[state->address>>16](state);debug_read; }
#define read_hword_in_memory() {state->readmemh[state->address>>16](state);debug_read; }
#define read_dword_in_memory() {state->readmemd[state->address>>16](state);debug_read; }
#define write_word_in_memory() {debug_writeW; state->writemem[state->address>>16](state);}
#define write_byte_in_memory() {debug_writeB; state->writememb[state->address >>16](state);}
#define write_hword_in_memory() {debug_writeHW; state->writememh[state->address >>16](state);}
#define write_dword_in_memory() {debug_writeDW; state->writememd[state->address >>16](state);}
