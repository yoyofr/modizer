...
#pragma pack(push,1)
      ...
      PACK_PRE struct ChunkGS : Chunk
      {
        ...
        uint8_t Level[4];
        uint8_t Flags;
        ruint16_t Registers[13];//af/bc/de/hl/af'/bc'/de'/hl'/ix/iy/sp/pc/ir
        uint8_t Iff[2];
        uint8_t ImMode;
        ruint32_t CyclesStart;
      ...
      PACK_PRE struct ChunkOPUS : Chunk
      {
        ...
        ruint32_t Flags;
        ruint32_t RamDataSize;
        ruint32_t RomDataSize;
