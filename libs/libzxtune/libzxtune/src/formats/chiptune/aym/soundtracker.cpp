...
//          const Ornament result(&src.Offsets[0], &src.Offsets[ORNAMENT_SIZE-1]);	// does not work
		  
		  Ornament result;
		  for (int i= 0; i<ORNAMENT_SIZE; i++) result.push_back(src.Offsets[i]);		  
