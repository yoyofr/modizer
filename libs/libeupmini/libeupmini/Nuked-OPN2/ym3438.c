// note: this is a somewhat stripped down version (see "XXX" comments marking disabled function calls)
//
...
void OPN2_Clock(ym3438_t *chip, Bit32s *buffer)
{
 ...
 //XXX   OPN2_DoTimerA(chip);
 //XXX   OPN2_DoTimerB(chip);
    OPN2_KeyOn(chip);
