...
__declspec(dllimport) bool WINAPI getlength(char *filename, long *length, int *loop);
__declspec(dllimport) bool WINAPI getlength2(char *filename, long *length, int *loop);
