...
__declspec(dllimport) bool WINAPI getlength(char *filename, int64_t *length, int *loop);
__declspec(dllimport) bool WINAPI getlength2(char *filename, int64_t *length, int *loop);
