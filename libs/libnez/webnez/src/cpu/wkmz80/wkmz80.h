...
void wkmz80_reset(KMZ80_CONTEXT *context);
void wkmr800_reset(KMZ80_CONTEXT *context);
void wkmdmg_reset(KMZ80_CONTEXT *context);
Uint32 wkmz80_exec(KMZ80_CONTEXT *context, Uint32 cycle);
