...
void  ZN_SPUwriteRegister(unsigned long reg, unsigned short val)
{
...
unsigned short  ZN_SPUreadRegister(unsigned long reg)
{
...
unsigned short  ZN_SPUreadDMA(void)
{
 return SPUreadDMA();
}
...
void  ZN_SPUwriteDMA(unsigned short val)
{
 SPUwriteDMA(val);
}
...
void  ZN_SPUwriteDMAMem(unsigned short * pusPSXMem,int iSize)
{
...
void  ZN_SPUreadDMAMem(unsigned short * pusPSXMem,int iSize)
{
...
void  ZN_SPUplayADPCMchannel(xa_decode_t *xap)
{
...
void  ZN_SPUregisterCallback(void ( *callback)(void))
{
...
long  ZN_SPUfreeze(unsigned long ulFreezeMode,void * pF)
{
...
void  ZN_SPUqsound(void ( *callback)(unsigned char *,long *,long))
{
 irqQSound = callback;
}
