...
private:
	...
	enum { TAGMASK = 0xFFFFFFFF << TAGSHIFT }; //use 0xFFFFFFFF instead of ~0
	enum { BLOCKMASK = (0xFFFFFFFF >> (32 - TAGSHIFT)) & (0xFFFFFFFF << BLOCKSIZESHIFT) };  //use 0xFFFFFFFF instead of ~0
