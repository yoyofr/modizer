...
#define YYERROR(x) nseel_yyerror(ctx, x)
...
{                                {
    assert(0);
//                                 YYSTYPE i = nseel_setVar(ctx,ctx->lastVar,yyvsp[-2]);
//                                 YYSTYPE v=nseel_getVar(ctx,i);
//
//                                 yyval = compiler->CreateCompiledExpression(FN_ASSIGN, v, yyvsp[0]);
//                                 ctx->result = yyval;
                                 }
                       ;
    break;}
...
//#ln 55 "cal.y"
      {
//          yyval = (YYSTYPE)compiler->CreateVariableReference( (intptr_t)yyvsp[0] ); //nseel_getVar(ctx,yyvsp[0]);;
            yyval = yyvsp[0] ; //nseel_getVar(ctx,yyvsp[0]);;
    break;}
case 5:
//#ln 57 "cal.y"
{       yyval = yyvsp[0];;
...
case 8:
//#ln 66 "cal.y"
{                                 yyval = (YYSTYPE)compiler->CreateCompiledExpression(FN_MULTIPLY, (ExpressionPtr)yyvsp[-2], (ExpressionPtr)yyvsp[0]);
    break;}
case 9:
//#ln 72 "cal.y"
{                                 yyval = (YYSTYPE)compiler->CreateCompiledExpression(FN_DIVIDE, (ExpressionPtr)yyvsp[-2], (ExpressionPtr)yyvsp[0]);
    break;}
case 10:
//#ln 78 "cal.y"
{                                  yyval = (YYSTYPE)compiler->CreateCompiledExpression(FN_MODULO, (ExpressionPtr)yyvsp[-2], (ExpressionPtr)yyvsp[0]);
    break;}
case 11:
//#ln 84 "cal.y"
{                                 yyval = (YYSTYPE)compiler->CreateCompiledExpression(FN_ADD, (ExpressionPtr)yyvsp[-2], (ExpressionPtr)yyvsp[0]);
    break;}
case 12:
//#ln 90 "cal.y"
{                                 yyval = (YYSTYPE)compiler->CreateCompiledExpression(FN_SUB, (ExpressionPtr)yyvsp[-2], (ExpressionPtr)yyvsp[0]);
    break;}
case 13:
//#ln 96 "cal.y"
{                                  yyval = (YYSTYPE)compiler->CreateCompiledExpression(FN_BITWISE_AND, (ExpressionPtr)yyvsp[-2], (ExpressionPtr)yyvsp[0]);
    break;}
case 14:
//#ln 102 "cal.y"
{                                  yyval = (YYSTYPE)compiler->CreateCompiledExpression(FN_BITWISE_OR, (ExpressionPtr)yyvsp[-2], (ExpressionPtr)yyvsp[0]);
    break;}
case 15:
//#ln 108 "cal.y"
{                                  yyval = (YYSTYPE)compiler->CreateCompiledExpression(FN_UMINUS, (ExpressionPtr)yyvsp[0]);
    break;}
case 16:
//#ln 114 "cal.y"
{                                 yyval = (YYSTYPE)compiler->CreateCompiledExpression(FN_UPLUS, (ExpressionPtr)yyvsp[0]);
    break;}
case 17:
//#ln 120 "cal.y"
{       yyval = yyvsp[0];     
...
case 18:
//#ln 125 "cal.y"
{                                  yyval = (YYSTYPE)compiler->CreateCompiledExpression((FuncType)yyvsp[-3], (ExpressionPtr)yyvsp[-1]);
    break;}
case 19:
//#ln 131 "cal.y"
{                                 yyval = (YYSTYPE)compiler->CreateCompiledExpression((FuncType)yyvsp[-5], (ExpressionPtr)yyvsp[-3], (ExpressionPtr)yyvsp[-1]);
    break;}
case 20:    
//#ln 137 "cal.y"
{                                 yyval = (YYSTYPE)compiler->CreateCompiledExpression((FuncType)yyvsp[-7], (ExpressionPtr)yyvsp[-5], (ExpressionPtr)yyvsp[-3], (ExpressionPtr)yyvsp[-1]);
    break;}
}
