...
ROT_MATRIX rot_s1;  // four random, static rotations.  randomized @ preset load time.
ROT_MATRIX rot_s2;  // minor translation component (<1).
ROT_MATRIX rot_s3;
ROT_MATRIX rot_s4;

ROT_MATRIX rot_d1;  // four random, slowly changing rotations.
ROT_MATRIX rot_d2;
ROT_MATRIX rot_d3;
ROT_MATRIX rot_d4;
ROT_MATRIX rot_f1;  // faster-changing.
ROT_MATRIX rot_f2;
ROT_MATRIX rot_f3;
ROT_MATRIX rot_f4;
ROT_MATRIX rot_vf1;  // very-fast-changing.
ROT_MATRIX rot_vf2;
ROT_MATRIX rot_vf3;
ROT_MATRIX rot_vf4;
ROT_MATRIX rot_uf1;  // ultra-fast-changing.
ROT_MATRIX rot_uf2;
ROT_MATRIX rot_uf3;
ROT_MATRIX rot_uf4;

ROT_MATRIX rot_rand1; // random every frame
ROT_MATRIX rot_rand2;
ROT_MATRIX rot_rand3;
ROT_MATRIX rot_rand4;
...
#define tex2d(s,uv)  tex2D(s,(uv))

// tex3D isn't supported yet on all platforms...fallback to 2D noise
#define tex3D(s,uvw) tex2D(s,(uvw).xy)
#define tex3d(s,uvw) tex3D(s,(uvw))

#define sampler sampler2D

// previous-frame-image samplers:
sampler2D sampler_main   ;
sampler2D sampler_fc_main;
sampler2D sampler_pc_main;
sampler2D sampler_fw_main;
sampler2D sampler_pw_main;
...
sampler2D sampler_noisevol_lq;
sampler2D sampler_noisevol_hq;
