...
// static INLINE void DeliverEvent(u32 ev, u32 spec) __attribute__ ((always_inline));
...
static void bios_rand() { // 2f
	v0 = 1+(int) (32767.0f*rand()/(RAND_MAX+1.0f));
	pc0 = ra;
}
