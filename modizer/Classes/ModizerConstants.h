...
#define SUPPORTED_FILETYPE_GME @"SAP,AY,GBS,GYM,HES,KSS,NSF,NSFE,SGC,SPC,VGM,VGZ"
#define SUPPORTED_FILETYPE_GME_WITHEXTFILE @"SAP,AY,GBS,GYM,HES,KSS,NSF,NSFE,SGC,SPC,VGM,VGZ"
#define SUPPORTED_FILETYPE_GME_EXT @"SAP,AY,GBS,GYM,HES,KSS,M3U,NSF,NSFE,SGC,SPC,VGM,VGZ"
//deleted: SAP
