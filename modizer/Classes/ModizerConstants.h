...
#define SUPPORTED_FILETYPE_MODPLUG @"FT,MOD,MO3,S3M,XM,MED,MMD3,MMD4,MMDC,MTM,IT,669,ULT,STM,FAR,WAV,AMF,AMS,DSM,MDL,OKT,DMF,PTM,DBM,MT2,AMF0,PSM,J2B,ABC,PAT,UMX,GDM,XPK,PPM,MMCMP"
//deleted : MID (use timidity instead)
//deleted : MMD0,MMD1,MMD2 (use UADE instead)
