...
inline uint32_t SBIT(uint32_t n) { return 1 << n; }
...
const int AMPL_THRESHOLD = AMPL_MIN * 128;// << 7;
...
const uint32_t SOUND_REPEAT = SBIT(27);
const uint32_t SOUND_ONE_SHOT = SBIT(28);
...
const uint32_t SCHANNEL_ENABLE = SBIT(31);
