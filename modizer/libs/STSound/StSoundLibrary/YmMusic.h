...
public:
	...
	ymbool	updateStereo(ymsample *pBuffer,ymint nbSample);
	ymu32	getPos(void);
...
//-------------------------------------------------------------
	...
	void	stDigitMixStereo(signed short *pWrite16,int nbs);
...
//-------------------------------------------------------------
	...
	void	ymTrackerUpdateStereo(signed short *pBuffer,int nbSample);
	...
	void	ymTrackerVoiceAddStereo(ymTrackerVoice_t *pVoice,signed short *pBuffer,int nbs);
