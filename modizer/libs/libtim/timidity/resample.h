...
extern retim_sample_t do_resamplation(tim_sample_t *src, splen_t ofs, resample_rec_t *rec);

extern retim_sample_t *resample_voice(int v, int32 *countptr);
