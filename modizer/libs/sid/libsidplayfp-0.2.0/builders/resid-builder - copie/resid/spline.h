...
// ----------------------------------------------------------------------------
inline
void cubic_coefficients(float x1, float y1, float x2, float y2,
			float k1, float k2,
...
inline
void interpolate_brute_force(float x1, float y1, float x2, float y2,
			     float k1, float k2,
...
template<class PointPlotter>
inline
void interpolate_forward_difference(float x1, float y1, float x2, float y2,
				    float k1, float k2,
				    PointPlotter plot, float res)
{
  float a, b, c, d;
...
inline
void interpolate(PointIter p0, PointIter pn, PointPlotter plot, float res)
{
  float k1, k2;
