...
//gather every entry of every user playlist
-(NSArray*) collectPlaylistsEntriesFullpaths {
    ...
    for (int i=0;i<plListSize;i++) {
        ...
        [entries addObjectsFromArray:fullpaths];
...
-(void) downloadMissingPlaylistsEntries {
    [self confirmDownloadMissingEntriesForPaths:[self collectPlaylistsEntriesFullpaths]];
}
