...
t_pattern_colortheme modpat_colorAlt={
    ...
    {0xF0,0xD0,0xF0},  //Instrument color
    {0xF0,0xD0,0xF0},  //Instrument color H
    {0xF0,0xF0,0xC0},  //Volume color
    {0xF0,0xF0,0xC0},  //Volume color H
    {0xD0,0xB0,0xF0},  //Effect nb color
    {0xD0,0xB0,0xF0},  //Effect nb color H
    {0xC0,0xA0,0xF0},  //Effect value color
    {0xC0,0xA0,0xF0},  //Effect value color H
