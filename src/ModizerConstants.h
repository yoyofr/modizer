...
#define SUPPORTED_FILETYPE_ZXTUNE @"TS,AY,PT3,PT2,STC,ST1,ST3,AS0,ASC,STP,TXT,PSG,PDT,CHI,STR,DST,SQD,DMM,PSM,GTR,PT1,VTX,YM,YM,TFD,TFC,SQT,PSC,FTC,COP,TF0,TFE,ET1,\
SZX,ZIP,SCL,HRP,FDI,BIN,P,HBT,HRM,DSQ,ESV,TLZ,TLZP,TRS,CC3,GAM,GAMPLUS,LZS,MSP,TD0,PCD"
