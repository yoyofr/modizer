...
#define SUPPORTED_FILETYPE_LAZYUSF_WITHEXTFILE @"xxxMINIUSF"
#define SUPPORTED_FILETYPE_LAZYUSF @"xxxUSF,xxxMINIUSF"
#define SUPPORTED_FILETYPE_LAZYUSF_EXT @"xxxUSF,xxxMINIUSF,xxxUSFLIB"
