...
#define SUPPORTED_FILETYPE_ZXTUNE @"AS0,ASC,AY,CHI,COP,DMM,DST,ET1,FTC,GTR,M,PDT,PSC,PSG,PSM,PT1,PT2,PT3,SQD,SQT,ST1,ST3,STC,STP,STR,TF0,TFC,TFD,TFE,TS,TXT,VTX,YM,\
SZX,SCL,HRP,FDI,BIN,P,HBT,HRM,DSQ,ESV,TLZ,TLZP,TRS,CC3,GAM,GAMPLUS,LZS,MSP,TD0,PCD"
