...
#define SUPPORTED_FILETYPE_SID @"SID,STR,MUS,C64,PRG,P00"
...
#define SUPPORTED_FILETYPE_OMPT @"MPTM,MOD,AS3M,S3M,XM,IT,669,AMF,AMS,C67,DBM,DIGI,DMF,DSM,DTM,FAR,IMF,ICE,J2B,M15,MDL,MED,MMDC,MMD0,MMD1,MMD2,MMS,MT2,MTM,NST,OKT,PLM,PSM,PT36,PTM,SFX,SFX2,ST26,STK,STM,STP,ULT,WOW,GDM,MO3,OXM,UMX,XPK,PPM,MMCMP"
...
#define SUPPORTED_FILETYPE_SNSF_WITHEXTFILE @"xxxxxMINISNSF"
#define SUPPORTED_FILETYPE_SNSF @"xxxSNSF,xxxMINISNSF"
#define SUPPORTED_FILETYPE_SNSF_EXT @"xxxxSNSF,xxxxMINISNSF,xxxSNSFLIB"
