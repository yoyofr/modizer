...
//PLAYBACK_FREQ/30
#define SOUND_BUFFER_NB 4 //64
#define MIDIFX_OFS 2 //32

#define SOUND_MAXVOICES_BUFFER_FX 64

#define SOUND_MAXMOD_CHANNELS 256

#define SOUND_VOICES_MAX_ACTIVE_CHIPS 16
...
#define SUPPORTED_FILETYPE_MODPLUG @"MPTM,MOD,S3M,XM,IT,669,AMF,AMS,C67,DBM,DIGI,DMF,DSM,DTM,FAR,IMF,ICE,J2B,M15,MDL,MED,MMDC,MMD0,MMD1,MMD2,MMS,MT2,MTM,NST,OKT,PLM,PSM,PT36,PTM,SFX,SFX2,ST26,STK,STM,STP,ULT,WOW,GDM,MO3,OXM,UMX,XPK,PPM,MMCMP"
...
#define SUPPORTED_FILETYPE_HC_WITHEXTFILE @"MINIPSF,MINIPSF2,MINIDSF,MINIQSF,MINISSF,MINIUSF"
#define SUPPORTED_FILETYPE_HC @"PSF,MINIPSF,PSF2,MINIPSF2,DSF,MINIDSF,QSF,MINIQSF,SSF,MINISSF,USF,MINIUSF"
#define SUPPORTED_FILETYPE_HC_EXT @"PSF,MINIPSF,PSF2,MINIPSF2,DSF,MINIDSF,QSF,MINIQSF,SSF,MINISSF,USF,MINIUSF,PSF2LIB,PSFLIB,DSFLIB,QSFLIB,SSFLIB,USFLIB"
...
#define SUPPORTED_FILETYPE_MPG123 @"xxxxxxMP3"
...
#define SUPPORTED_FILETYPE_SNSF @"xxxxxSNSF,xxxxxMINISNSF"
#define SUPPORTED_FILETYPE_SNSF_EXT @"xxxxxSNSF,xxxxxMINISNSF,xxxxxSNSFLIB"
