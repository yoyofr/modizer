...
#define SUPPORTED_FILETYPE_OMPT @"MPTM,MOD,AS3M,S3M,XM,IT,669,AMF,AMS,C67,DBM,DIGI,DMF,DSM,DTM,FAR,IMF,ICE,J2B,M15,MDL,MED,MMDC,MMD0,MMD1,MMD2,MMD3,MMD4,MMS,MT2,MTM,NST,OKT,PLM,PSM,PT36,PTM,SFX,SFX2,ST26,STK,STM,STP,ULT,WOW,GDM,MO3,OXM,UMX,XPK,PPM,MMCMP,FST"

#define SUPPORTED_FILETYPE_XMP @"MED,MMD0,MMD1,MMD2,MMD3,MMD4,MOD,S3M,XM,IT,FLX,AMF,GMC,J2B,PSM,UMX,GDM,669,FNK,LIQ,WOW,MTM,PTM,RTM,STM,ULT,DMF,KRIS,DBM,FST"

#define SUPPORTED_FILETYPE_KSS @"KSS,MGS,BGM,OPX,MPK,MBM"

#define SUPPORTED_FILETYPE_GME_WITHEXTFILE  @"GBS,GYM,HES,KSS,NSF,NSFE,SAP,SFM,SGC,SPC,VGM,VGZ" //AY
#define SUPPORTED_FILETYPE_GME              @"GBS,GYM,HES,KSS,NSF,NSFE,SAP,SFM,SGC,SPC,VGM,VGZ"  //AY
#define SUPPORTED_FILETYPE_GME_EXT          @"GBS,GYM,HES,KSS,M3U,NSF,NSFE,SAP,SFM,SGC,SPC,VGM,VGZ"  //AY
