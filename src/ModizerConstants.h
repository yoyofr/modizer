...
#define SUPPORTED_FILETYPE_ZXTUNE @"AS0,ASC,AY,CHI,CHP,COP,DMM,DST,ET1,FTC,GTR,M,PDT,PSC,PSG,PSM,PT1,PT2,PT3,SQD,SQT,ST1,ST3,STC,STP,STR,TF0,TFC,TFD,TFE,TRD,TS,TXT,VTX,YM,\
SZX,SCL,HRP,FDI,BIN,P,HBT,HRM,DSQ,ESV,TLZ,TLZP,TRS,CC3,GAM,GAMPLUS,LZS,MSP,TD0,PCD,ZXZIP"  //,ZIP
...
VSS,WB,ML,MOD15_ST-IV,AGI,TPU,QPA,SQT,QTS,OSS"
...
#define SUPPORTED_FILETYPE_OMPT @"MPTM,MOD,AS3M,S3M,XM,IT,669,AMF,AMS,C67,DBM,DIGI,DMF,DSM,DTM,FAR,IMF,ICE,J2B,M15,MDL,MED,MMDC,MMD0,MMD1,MMD2,MMD3,MMD4,MMS,MT2,MTM,NST,OKT,PLM,PSM,PT36,PTM,SFX,SFX2,ST26,STK,STM,STP,ULT,WOW,GDM,MO3,OXM,UMX,XPK,PPM,MMCMP,FST,OSS"

#define SUPPORTED_FILETYPE_XMP @"MED,MMD0,MMD1,MMD2,MMD3,MMD4,MOD,S3M,XM,IT,FLX,AMF,GMC,J2B,PSM,UMX,GDM,669,FNK,LIQ,WOW,MTM,PTM,RTM,STM,ULT,DMF,KRIS,DBM,FST,OSS"

#define SUPPORTED_FILETYPE_KSS @"KSS,MGS,BGM,OPX,MPK,MBM"

#define SUPPORTED_FILETYPE_GME_WITHEXTFILE  @"GBS,GYM,HES,KSS,NSF,NSFE,SAP,SFM,SPC,VGM,VGZ" //AY
#define SUPPORTED_FILETYPE_GME              @"GBS,GYM,HES,KSS,NSF,NSFE,SAP,SFM,SPC,VGM,VGZ"  //AY
#define SUPPORTED_FILETYPE_GME_EXT          @"GBS,GYM,HES,KSS,M3U,NSF,NSFE,SAP,SFM,SPC,VGM,VGZ"  //AY

#define SUPPORTED_FILETYPE_ADPLUG @"A2M,ADL,ADLIB,AGD,AMD,AS3M,BAM,BMF,CFF,CMF,D00,DFM,DM0,DMO,DR0,DRO,DTM,GOT,HA2,HSC,HSP,HSQ,IMF,IMS,JBM,KSM,LAA,LDS,M,MAD,MDI,MDY,MID,MKF,MKJ,MSC,MTK,MTR,MUS,PIS,RAC,RAD,RAW,RIX,ROL,S3M,SA2,SAT,SCI,SDB,SNG,SOP,SQX,WLF,XAD,XSM"
//removed: as3m, s3m
//@"A2M,ADL,ADLIB,AGD,AMD,BAM,BMF,CFF,CMF,D00,DFM,DM0,DMO,DR0,DRO,DTM,GOT,HA2,HSC,HSP,HSQ,IMF,IMS,JBM,KSM,LAA,LDS,M,MAD,MDI,MID,MKJ,MSC,MTK,MUS,RAC,RAD,RAW,RIX,ROL,SA2,SAT,SCI,SDB,SNG,SOP,SQX,XAD,XMS,XSM,WLF"
