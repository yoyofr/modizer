...
unsigned XSFConfigSNSF::initSampleRate = 44100;
std::string XSFConfigSNSF::commonName = "SNSF Decoder";
std::string XSFConfigSNSF::versionNumber = "0.9b";
//bool XSFConfigSNSF::initSixteenBitSound = true;
...
XSFConfig_SNSF::XSFConfig_SNSF() : XSFConfigSNSF(), /*sixteenBitSound(false), */reverseStereo(false), mutes(), resampler(0)
{
...
void XSFConfig_SNSF::CopySpecificConfigToMemory(XSFPlayerSNSF *, bool preLoad)
{
	if (preLoad)
	{
