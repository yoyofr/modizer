...
//IOS_BUILD_PATCH
typedef unsigned int/*UINT32*/		Bitu;
typedef signed int/*INT32*/		Bits;
typedef unsigned int/*UINT32*/		Bit32u;
typedef signed int/*INT32*/		Bit32s;
typedef unsigned short/*UINT16*/		Bit16u;
typedef signed short/*INT16*/		Bit16s;
typedef unsigned char/*UINT8*/		Bit8u;
typedef signed char/*INT8*/		Bit8s;
