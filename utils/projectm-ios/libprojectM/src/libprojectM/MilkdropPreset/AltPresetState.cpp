...
const glm::mat4 AltPresetState::orthogonalProjection = glm::ortho(-1.0f, 1.0f, 1.0f, -1.0f, -40.0f, 40.0f);
const glm::mat4 AltPresetState::orthogonalProjectionFlipped = glm::ortho(-1.0f, 1.0f, -1.0f, 1.0f, -40.0f, 40.0f);

AltPresetState::AltPresetState()
...
void AltPresetState::Initialize(::libprojectM::PresetFileParser& parsedFile)
{
