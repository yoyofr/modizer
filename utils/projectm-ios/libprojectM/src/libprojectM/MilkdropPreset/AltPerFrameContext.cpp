...
AltPerFrameContext::AltPerFrameContext(projectm_eval_mem_buffer gmegabuf, PRJM_EVAL_F (*globalRegisters)[100])
    : perFrameCodeContext(projectm_eval_context_create(gmegabuf, globalRegisters))
{
}

AltPerFrameContext::~AltPerFrameContext()
{
...
void AltPerFrameContext::RegisterBuiltinVariables()
{
...
void AltPerFrameContext::EvaluateInitCode(AltPresetState& state)
{
...
void AltPerFrameContext::LoadStateVariables(AltPresetState& state)
{
...
void AltPerFrameContext::CompilePerFrameCode(const std::string& perFrameCode)
{
...
void AltPerFrameContext::ExecutePerFrameCode()
{
    if (perFrameCodeHandle != nullptr)
    {
