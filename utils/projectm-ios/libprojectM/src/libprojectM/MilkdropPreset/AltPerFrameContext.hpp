...
public:
     ...
     */
    AltPerFrameContext(projectm_eval_mem_buffer gmegabuf, PRJM_EVAL_F (*globalRegisters)[100]);
     ...
     */
    void LoadStateVariables(AltPresetState& state);
     ...
     */
    void EvaluateInitCode(AltPresetState& state);
