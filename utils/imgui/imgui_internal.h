...
//YOYOFR
IMGUI_API ImVec2        ImFontCalcTextSizeEx(ImFont* font, float size, float max_width, float wrap_width, const char* text_begin, const char* text_end_display, const char* text_end, const char** out_remaining, ImVec2* out_offset, ImDrawTextFlags flags, int textFlags=0);
...
enum ImGuiTextFlags_
{
    ...
    ImGuiTextFlags_ParseColors                  = 1 << 1, //YOYOFR
};
...
//#endif
    ...
    IMGUI_API void          RenderTextWrapped(ImVec2 pos, const char* text, const char* text_end, float wrap_width, int textFlags=0);
    IMGUI_API void          RenderTextWrappedZoom(ImVec2 pos, const char* text, const char* text_end, float wrap_width, float glyph_zoom, int textFlags=0);
